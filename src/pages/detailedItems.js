            ...
            <div >
                <div className="d-flex justify-content-between">
                    ...
                    <div className="float-right">
                        <NavLink className="accessRowItemsRightIn" to="" ><button type="button" className="btn btn-primary">Next</button></NavLink>
                        <NavLink className="accessRowItemsRight" to="/Products" >
                            <button type="button" className="btn btn-primary">Về danh sách</button>
                        </NavLink> 
                    </div>
                </div>
                    ...
                    <div className="row">
                        <div className="col-md col-md-8">
                            <div style={{width: 500, height: 400}}>
                                <Slide images={detailpost.image} styles={{width: 500, height: 400}} />
                            </div>
                            ...
                            <div>
                                <input className="" placeholder="Đưa ra nhận xét tại đây" type="text" />
                            </div>
                        </div>
