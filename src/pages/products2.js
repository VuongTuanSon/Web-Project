...
import list2 from './images/list-item2.jpg'
function Products2() {
    return (
        <div className="ekvnxp">
            <div className="ergipz">
                ...
                <NavLink to="" className="wrap-list">
                    <img src={list2} className="wrap-list-img" />
                    <div className="wrap-list-body">
                        ...
                        <div className="wrap-list-content-lowerhalf">
                            <span className="wrap-list-price">4.3 triệu</span>
                ...
                <ul className="productLists">
                    ...
                    <li className="listItems"><Link to="">2</Link></li>
